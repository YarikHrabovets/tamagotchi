...
class FoodMenu:
    ...
    def hover(self, x, y):
        if self.box_1_rect.collidepoint((x, y)):
            ...
            self.box_1 = pygame.transform.scale(pygame.image.load('images/sprites/buttonSquare_blue.png'), (150, 150))
        else:
        ...
        if self.box_2_rect.collidepoint((x, y)):
            ...
            self.box_2 = pygame.transform.scale(pygame.image.load('images/sprites/buttonSquare_blue.png'), (150, 150))
        else:
        ...
        if self.box_3_rect.collidepoint((x, y)):
            ...
            self.box_3 = pygame.transform.scale(pygame.image.load('images/sprites/buttonSquare_blue.png'), (150, 150))
        else:
